...
<div id="testimonial" class="testimonial-section section white-bg pb-120">
			<div class="imagebg">
				<img src="backend/images//testimonial-bg.png" alt="testimonial-bg">
			</div>
			<div class="container">
					...
					<div class="col-md-8 col-md-offset-2">
						<div class="testimonial-carousel has-carousel" data-items="1" data-loop="true" data-dots="true" data-auto="true" data-navs="false">
							<div class="item text-center">
								<div class="quotes">
									<img src="backend/images//quote-icon.png" class="quote-icon" alt="quote-icon" />
									...
									<div class="client-image">
										<img src="backend/images//client-1.jpg" alt="client" />
									</div>
								</div>
							</div>
							<div class="item text-center">
								<div class="quotes">
									...
									<h6>Andy Lovell</h6>
									<div class="client-image">
										<img src="backend/images//client-2.jpg" alt="client" />
									</div>
								</div>
							</div>
							<div class="item text-center">
